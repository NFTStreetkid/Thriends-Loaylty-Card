...
const Home: NextPage = () => {
  ...
  return (
    <main className={styles.container}>
      <Header />
      <text>Welcome to the Thriends Loyalty Dashboard! I am thrilled to have you onboard. If you are reading this, it means you have successfully joined my project.</text>
      <Web3Button
        action={() => generate()}
